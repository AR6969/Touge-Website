California Touge road collection — September 8, 2026
...
Traces select named road sections inside regional bounding boxes; they are not
turn-by-turn routes. Gaps are not bridged. 17-Mile Drive is a trace of the named
...
Retrieved via https://overpass-api.de/api/interpreter on September 8, 2026.
Build recipe: scripts/build-road-data.py, then scripts/build-derived-data.py.
