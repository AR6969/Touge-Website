...
export const regionIntroductions: Record<string, string> = {
  ...
  "great-smoky-mountains": "Tail of the Dragon is the anchor: 318 curves in 11 miles at Deals Gap. Cherohala Skyway meets it at the Robbinsville end with a completely different, longer-sweeper character, while Moonshiner 28 continues south from the Dragon's other end for another 55 miles of nearly continuous curves toward Franklin. Foothills Parkway starts at the Dragon's own Chilhowee end and drives nothing like it — wide, sweeping ridge road instead of tight switchbacks. Check each road's access notes — winter conditions and detour traffic both affect this area.",
  ...
  "nantahala-national-forest": "Cullasaja Gorge (US 64) drops out of Highlands past waterfalls in its first several miles, and has real, recent storm-damage closure history — check current North Carolina conditions before a trip, not just seasonal weather.",
  ...
  "roan-highlands": "NC 261 and TN 143 combine into one continuous 25-mile route over Roan Mountain, meeting at Carvers Gap where the Appalachian Trail crosses the road — genuinely technical on both sides, through Cherokee National Forest and Roan Mountain State Park.",
  ...
  "front-range": "Three close-to-Denver roads with different personalities: Lookout Mountain Road is a short switchback climb out of Golden shared heavily with cyclists, Mount Blue Sky Road climbs toward 14,000 ft and now requires a seasonal reservation, and Deer Creek Canyon Road is a sweeping foothills favorite between Chatfield and Evergreen.",
  "north-cascades": "The North Cascades Highway (SR 20) is the last major road built across Washington's Cascades — closed completely every winter, unlike Sherman Pass further east on the same highway.",
  "colville-national-forest": "Sherman Pass (SR 20) is Washington's highest maintained pass, and the only major one kept open year-round rather than gated for winter.",
  "puget-sound": "Chuckanut Drive (SR 11) hugs the Puget Sound coast on sandstone cliffs between Bellingham and Blanchard — narrow, twisty in places, and genuinely crowded on weekends.",
  "yakima-river-canyon": "Yakima Canyon Road (SR 821) follows the Yakima River between Selah and Ellensburg past basalt cliffs — minimal traffic outside holiday weekends, narrow shoulders the rest of the time.",
