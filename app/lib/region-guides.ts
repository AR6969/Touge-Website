...
export const regionIntroductions: Record<string, string> = {
  ...
  "malibu-santa-monica-mountains": "Compare Latigo, Piuma and Stunt for winding canyon roads, or look at Pacific Coast Highway for the coastal section. Mulholland Highway and its Snake section have separate pages; they are distinct from Mulholland Drive in the Hollywood Hills. Use the road pages to check the exact section and access notes.",
